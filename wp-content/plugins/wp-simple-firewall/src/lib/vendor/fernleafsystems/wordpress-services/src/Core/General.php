...
class General {
	...
	public function isLoginUrl() :bool {
		...
		return \trim( Services::Request()->getPath(), '/' ) == \trim( $sLoginPath, '/' );
	}
	 ...
	 * @deprecated
	 */
	public function getPluginUpgradeLink( $pluginFile ) {
		return Services::WpPlugins()->getLinkPluginUpgrade( $pluginFile );
	}
